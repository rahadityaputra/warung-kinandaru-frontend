      ...
      <nav className="sticky z-20 bg-white top-0 p-4 h-[70px] flex flex-row justify-between sm:items-center sm:justify-between gap-3 shadow-md">
        <div className="flex gap-2 w-full sm:w-80 sm:mx-0">
          <input
            ...
            className="rounded-lg pl-2 pr-2 w-full text-sm text-gray-800 bg-white border border-green-400 focus:outline-none focus:ring-2 focus:ring-green-300 focus:border-transparent transition duration-200 shadow-sm"
          />
          <button
